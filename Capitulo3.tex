...
\hline
        ...
        Asignar nombre al jugador cuando no puso ninguno en el \textit{lobby} & 25/05/2021 & 26/05/2021 & 1 \\ \hline
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}{0.4\textwidth}
            ...
            \caption{En este tiene que seleccionar el ciclo que escriba en pantalla del 1 al 10}
        ...
        \begin{subfigure}{0.4\textwidth}
            ...
            \label{fig:puzzle_completar_ciclos_while}
        \end{subfigure}
        \caption{Capturas de pantalla de puzzle de opción múltiple}
